...
_RESEARCH_QUESTIONS: list[IntakeQuestion] = [
    ...
    IntakeQuestion(
        ...
        why_asked="Annual price per lab is the sp term in TAM = pop × sp — a 10× price difference changes TAM by 10×.",
        input_type="single",
        options=[
    ...
    IntakeQuestion(
        id="rq_target_lab_count",
        text="How many US research labs of the relevant type could realistically use this product?",
        binds_to="seg.target_lab_count",
        why_asked="Lab population is the pop term in TAM = pop × price — the single largest driver of market size.",
        input_type="single",
        options=[
            "Fewer than 1,000 labs — highly specialized niche",
            "1,000–5,000 labs — defined research domain",
            "5,000–20,000 labs — broad research category",
            "Over 20,000 labs — any lab with storage-intensive instruments",
        ],
        default=None,
        impact_rank=6,
    ),
