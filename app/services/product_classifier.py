...
_RESEARCH_QUESTIONS: list[IntakeQuestion] = [
    IntakeQuestion(
        id="rq_buyer_persona",
        text="Who is the primary decision-maker who adopts and pays for your product?",
        binds_to="buyer.persona",
        why_asked="Buyer persona determines deal structure, sales cycle length, and price ceiling.",
        input_type="single",
        options=[
            "Individual PI or lab director — purchases from discretionary lab budget",
            "Graduate student / postdoc — bottom-up viral adoption, PI ratifies the spend later",
            "Core facility director — institutional procurement, serves multiple labs under one contract",
            "Industry R&D lab (pharma / biotech) — formal vendor qualification required",
        ],
        default=None,
        impact_rank=1,
    ),
    IntakeQuestion(
        id="rq_price_band",
        text="What is the expected annual price per lab?",
        binds_to="price.annual_per_lab",
        why_asked="Annual price per lab is the sp term in TAM = pop × sp — a 10× price difference changes TAM by 10×. Q2/Q3/Q4 options MUST include the exact numbers shown — the backend parses them.",
        input_type="single",
        options=[
            "Under $500/yr — consumable-level or grant-incidental spend",
            "$500–$2,000/yr — standard research software subscription",
            "$2,000–$8,000/yr — mid-tier lab infrastructure tool",
            "$8,000–$25,000/yr — core facility or institutional license",
        ],
        default=None,
        impact_rank=2,
    ...
    IntakeQuestion(
        id="rq_instrument_requirement",
        text="What does a research lab need to have in order to use your product?",
        binds_to="seg.instrument_requirement",
        why_asked="The minimum hardware/infrastructure requirement is the sharpest filter on addressable labs — it sets the population ceiling in TAM = pop × price. Options MUST include the exact numbers shown — the backend parses them to derive market size.",
        input_type="single",
        options=[
            "Any internet-connected computer — no specialized instruments required (~30,000–80,000 US academic research labs)",
            "Labs with specific data-generating instruments (e.g., electrophysiology rigs, sequencers, imagers) (~5,000–20,000 qualifying labs)",
    ...
    IntakeQuestion(
        id="rq_primary_workflow",
        text="What is the core workflow or problem your product addresses inside the lab?",
        binds_to="seg.workflow_type",
        why_asked="Workflow type determines how deeply the product embeds into lab operations and therefore the serviceable fraction of qualifying labs.",
        input_type="single",
        options=[
            ...
            "Lab operations or protocol coordination — teams use it to organize, track, and document work",
    ...
    IntakeQuestion(
        id="rq_status_quo",
        text="What do labs currently use instead of your product?",
        binds_to="comp.status_quo",
        why_asked="The incumbent (manual process, DIY, or commercial tool) anchors switching cost and competitive moat score.",
        input_type="single",
        options=[
            "Manual process by grad students or lab staff — no dedicated software or hardware",
            "DIY scripts or home-built tools — custom Python, MATLAB, Bash, or in-house software",
            "Open-source alternative (e.g., Bonsai, custom pipelines, free community tools)",
            "Commercial incumbent — a paid software or hardware system the lab currently subscribes to",
        ],
        default=None,
        impact_rank=5,
    ),
    IntakeQuestion(
        id="rq_adoption_pathway",
        text="How do new labs typically discover and start using your product?",
        binds_to="seg.adoption_pathway",
        why_asked="Adoption pathway determines how fast the product penetrates the addressable market — peer-viral spread is 2–3× faster than grant-cycle adoption.",
        input_type="single",
        options=[
            "Peer-to-peer among researchers — a grad student or postdoc finds it and recommends it within their network",
            "PI-led evaluation — the lab PI initiates a deliberate pilot after a referral or demo, then commits the lab",
