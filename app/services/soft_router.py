...
_SIGNAL_PRIORS: dict[str, dict[str, float]] = {
    ...
    "retina":              {"biologic_immunology": 0.55, "biologic_rare_disease": 0.15, "device_ophthalmology": 0.30},  # H-16: biologic_oncology removed — 9x price overestimate vs anti-VEGF/complement ~$2K/dose; immunology proxy appropriate
